.\setup-x86.exe -P vim -P openssh -P rsync -P gcc-g++ -P make -P wget -P curl -P dos2unix -P git -P tig -P zsh -P tmux -s http://mirror.cc.columbia.edu/pub/software/cygwin/
pause
